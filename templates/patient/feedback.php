            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <?php
                ...
                echo'<div class="row">';
                  echo'<div class="form-group mt-3">';
                  echo'物治師回饋';
                  echo'<input type="text" name="pt_feedback" class="form-control" value='.$row_result["PT_FEEDBACK"].' readonly/>';
                  echo'<div class="validate"></div>';
                  echo'</div>';
                echo'</div>';
                
                echo'<a href="historylog.php"><div class="text-center loginbtn"><button>回到復健紀錄</button></div></a>';
              }	
              else{
