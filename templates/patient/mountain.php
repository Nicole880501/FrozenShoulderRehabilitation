      ...
      <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
			...
			<div class="camwindow">
				...
				<iframe src="{{url_for('static',filename='/img/10seconds.mp4')}}" width="100%" controls loop autoplay="1"></iframe>
				...
				雙手手掌朝前，自然垂下，並逐漸將雙手與身體同一平面抬起，直至可忍耐的疼痛程度，並於該位置維持10秒再放下。
