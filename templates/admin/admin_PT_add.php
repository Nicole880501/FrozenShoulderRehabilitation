        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row mt-1">
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <form action="forms/contact.php" method="post" role="form">  <!--新增物治師php-->
                <div class="row">
                  <div class="col-md-6 form-group">
                    <input type="text" name="name" class="form-control" id="name" placeholder="物治師姓名" data-rule="minlen:1" data-msg="物治師姓名為必填欄位" />
                    <div class="validate"></div>
                  </div>
                  <div class="col-md-6 form-group mt-3 mt-md-0">
                    <input type="text" name="pt_id" class="form-control" id="pt_id" placeholder="物治師職編" data-rule="minlen:1" data-msg="物治師職編為必填欄位(7碼)" />
                    <div class="validate"></div>
                  </div>
                </div>
                ...
                <div class="text-center loginbtn"><a href="admin_PT.php"><button type="submit">建立物治師資料</button></a></div>
              </form>
            </div>
          </div>
        </div>
