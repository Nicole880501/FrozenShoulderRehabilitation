...
<html lang="zh-tw"><!--設定為繁體中文-->
    ...
    <body>
        ...
        <!-- 示範影片與使用者畫面-->
        <p style="font-size: 25px; margin-top:10px; margin-left: 30px; font-weight: bolder;">雙手後伸運動</p>
        <table class="table">
            <!-- 第一橫排 -->
            <tr>
                <td class="pose_td" >
            ...
            <tr> <!-- 第二橫排 -->
                ...
                <td>
                    <img src="{{ url_for('BW_E') }}" width="100%">
                    <!--vid>
                        <video id="vid"></video>
                    </vid>-->
                </td> 
            ...
            <tr>
                <td class="pose_td">
                    <p class='info'>身體直立，將雙臂向後伸展，直至可忍耐的疼痛程度，並於該位置維持10秒再放下。
